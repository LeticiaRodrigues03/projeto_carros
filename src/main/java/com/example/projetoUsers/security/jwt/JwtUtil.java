package com.example.projetoUsers.security.jwt;
...
//        System.out.println(expiration);
        ...
        //Chama a API da jsonwebtoken
        return Jwts.builder()
                .signWith(Keys.hmacShaKeyFor(signingKey), SignatureAlgorithm.HS512)
                //Subject = usuário ADMIN ou USER
